function LogosNodejs(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <defs>
        <linearGradient
          id="IconifyId1957915b39deb6f936"
          x1="68.188%"
          x2="27.823%"
          y1="17.487%"
          y2="89.755%"
        ...
        <linearGradient
          id="IconifyId1957915b39deb6f937"
          x1="43.277%"
          x2="159.245%"
          y1="55.169%"
          y2="-18.306%"
        ...
        <linearGradient
          id="IconifyId1957915b39deb6f938"
          x1="-4413.77%"
          x2="5327.93%"
          y1="13.43%"
          y2="13.43%"
        ...
        <linearGradient
          id="IconifyId1957915b39deb6f939"
          x1="-4.389%"
          x2="101.499%"
          y1="49.997%"
          y2="49.997%"
        ...
        <linearGradient
          id="IconifyId1957915b39deb6f9310"
          x1="-9713.77%"
          x2="27.93%"
          y1="36.21%"
          y2="36.21%"
        ...
        <linearGradient
          id="IconifyId1957915b39deb6f9311"
          x1="-103.861%"
          x2="100.797%"
          y1="50.275%"
          y2="50.275%"
        ...
        <linearGradient
          id="IconifyId1957915b39deb6f9312"
          x1="130.613%"
          x2="4.393%"
          y1="-211.069%"
          y2="201.605%"
        ...
        <path
          id="IconifyId1957915b39deb6f9313"
      ...
      <g fill="none">
        ...
        <g transform="translate(134.068 70.501)">
          <mask id="IconifyId1957915b39deb6f9314" fill="#fff">
            <use href="#IconifyId1957915b39deb6f9313" />
          </mask>
          <use
            fill="url(#IconifyId1957915b39deb6f936)"
            href="#IconifyId1957915b39deb6f9313"
          />
          <g mask="url(#IconifyId1957915b39deb6f9314)">
            ...
            <path
              fill="url(#IconifyId1957915b39deb6f937)"
          ...
          <g mask="url(#IconifyId1957915b39deb6f9314)">
            ...
            <path
              fill="url(#IconifyId1957915b39deb6f938)"
              fill-rule="evenodd"
              d="m50.391.809l-.693.347h.924z"
              transform="translate(0 -9.246)"
            />
            <path
              fill="url(#IconifyId1957915b39deb6f939)"
              fill-rule="evenodd"
            ...
            />
            <path
              fill="url(#IconifyId1957915b39deb6f9310)"
              fill-rule="evenodd"
              d="m111.3 104.712l-.347-.578v.809z"
              transform="translate(0 -9.246)"
            />
            <path
              fill="url(#IconifyId1957915b39deb6f9311)"
              fill-rule="evenodd"
            ...
            />
            <path
              fill="url(#IconifyId1957915b39deb6f9312)"
              fill-rule="evenodd"
              d="m106.792 105.636l-48.773 28.085a7 7 0 0 1-2.196.693l.925 1.734l54.089-31.32v-.694l-1.387-2.312c-.231 1.618-1.271 3.005-2.658 3.814"
              transform="translate(0 -9.246)"
            />
